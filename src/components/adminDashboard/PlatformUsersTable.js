...
function PlatformUsersTable({ props = [], tableTitle, onViewDriver }) {
  console.log("PlatformUsersTable props", props);
  ...
  const sortedUsers = [...props]?.sort((a, b) => {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {sortedPaginatedUsers?.map((driver, i) => {
